...
if sys.platform != "win32":
    # Linux: re-export the Proton-prefix-aware shim so existing
    # 'from WindowsKnownPaths import ...' call sites work unmodified.
    from edap_linux import get_path, FOLDERID, UserHandle  # noqa: F401
else:
    import ctypes
