...
# Limitations:
* Windows and Linux. This fork adds Linux/Proton support (see [README-linux.md](README-linux.md)); upstream is Windows-only
...
| Binding                | Name                         | Location under OPTIONS > CONTROLS            | Example   |
|------------------------|------------------------------|----------------------------------------------|-----------|
| UI_Up                  | UI PANEL UP                  | GENERAL CONTROLS > INTERFACE MODE            | U Arrow   |
| UI_Down                | UI PANEL DOWN                | GENERAL CONTROLS > INTERFACE MODE            | D Arrow   |
| UI_Left                | UI PANEL LEFT                | GENERAL CONTROLS > INTERFACE MODE            | L Arrow   |
| UI_Right               | UI PANEL RIGHT               | GENERAL CONTROLS > INTERFACE MODE            | R Arrow   |
| UI_Select              | UI PANEL SELECT              | GENERAL CONTROLS > INTERFACE MODE            | Space     |
| UI_Back                | UI Back                      | GENERAL CONTROLS > INTERFACE MODE            | Backspace |
| CycleNextPanel         | NEXT PANEL TAB               | GENERAL CONTROLS > INTERFACE MODE            | E         |
|                        |                              |                                              |           |
| MouseReset             | RESET MOUSE                  | SHIP CONTROLS > MOUSE CONTROLS               | ;         |
|                        |                              |                                              |           |
| YawLeftButton          | YAW LEFT                     | SHIP CONTROLS > FLIGHT ROTATION              | A         |
| YawRightButton         | YAW RIGHT                    | SHIP CONTROLS > FLIGHT ROTATION              | D         |
| RollLeftButton         | ROLL LEFT                    | SHIP CONTROLS > FLIGHT ROTATION              | Q         |
| RollRightButton        | ROLL RIGHT                   | SHIP CONTROLS > FLIGHT ROTATION              | E         |
| PitchUpButton          | PITCH UP                     | SHIP CONTROLS > FLIGHT ROTATION              | 6         |
| PitchDownButton        | PITCH DOWN                   | SHIP CONTROLS > FLIGHT ROTATION              | T         |
|                        |                              |                                              |           |
| ThrustUpButton         | THRUST UP                    | SHIP CONTROLS > FLIGHT THRUST                | R         |
|                        |                              |                                              |           |
| SetSpeedZero           | SET SPEED TO 0%              | SHIP CONTROLS > FLIGHT THROTTLE              | X         |
| SetSpeed50             | SET SPEED TO 50%             | SHIP CONTROLS > FLIGHT THROTTLE              | [         |
| SetSpeed100            | SET SPEED TO 100%            | SHIP CONTROLS > FLIGHT THROTTLE              | ]         |
|                        |                              |                                              |           |
| UseBoostJuice          | ENGINE BOOST                 | SHIP CONTROLS > FLIGHT MISCELLANEOUS         | Tab       |
| HyperSuperCombination  | TOGGLE FRAME SHIFT DRIVE     | SHIP CONTROLS > FLIGHT MISCELLANEOUS         | `         |
| Supercruise            | SUPERCRUISE                  | SHIP CONTROLS > FLIGHT MISCELLANEOUS         | K         |
|                        |                              |                                              |           |
| SelectTarget           | SELECT TARGET AHEAD          | SHIP CONTROLS > TARGETING                    | B         |
| TargetNextRouteSystem  | TARGET NEXT SYSTEM IN ROUTE  | SHIP CONTROLS > TARGETING                    | J         |  
|                        |                              |                                              |           |
| PrimaryFire            | PRIMARY FIRE                 | SHIP CONTROLS > WEAPONS                      | Num *     |
| SecondaryFire          | SECONDARY FIRE               | SHIP CONTROLS > WEAPONS                      | Num -     |
| DeployHardpointToggle  | DEPLOY HARDPOINTS            | SHIP CONTROLS > WEAPONS                      | U         |
|                        |                              |                                              |           |
| DeployHeatSink         | DEPLOY HEATSINK              | SHIP CONTROLS > COOLING                      | L Alt+H   |
|                        |                              |                                              |           |
| IncreaseEnginesPower   | DIVERT POWER TO ENGINES      | SHIP CONTROLS > MISCELLANEOUS                | U Arrow   |
| IncreaseWeaponsPower   | DIVERT POWER TO WEAPONS      | SHIP CONTROLS > MISCELLANEOUS                | R Arrow   |
| IncreaseSystemsPower   | DIVERT POWER TO SYSTEMS      | SHIP CONTROLS > MISCELLANEOUS                | L Arrow   |
| LandingGearToggle      | LANDING GEAR                 | SHIP CONTROLS > MISCELLANEOUS                | D Arrow   |
|                        |                              |                                              |           |
| UIFocus                | UI FOCUS                     | SHIP CONTROLS > MODE SWITCHES                | L Shift   |
| GalaxyMapOpen          | OPEN GALAXY MAP              | SHIP CONTROLS > MODE SWITCHES                | M         |
| SystemMapOpen          | OPEN SYSTEM MAP              | SHIP CONTROLS > MODE SWITCHES                | ,         |
| ExplorationFSSEnter    | ENTER FSS MODE               | SHIP CONTROLS > MODE SWITCHES                | L Ctrl+`  |
|                        |                              |                                              |           |
| HeadLookReset          | RESET HEADLOOK               | SHIP CONTROLS > HEADLOOK MODE                | L Shift+H |
|                        |                              |                                              |           |
